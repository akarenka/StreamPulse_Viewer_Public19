...
The included `firebase-config.js` points to the existing Firebase project `emostreamwebsite`.

## 1. Enable authentication

1. Open Firebase Console and select `EmoStreamWebsite` (`emostreamwebsite`).
